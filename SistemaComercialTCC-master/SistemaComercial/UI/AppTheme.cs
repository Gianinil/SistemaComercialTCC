...
public static class AppTheme
{
    ...
    public static readonly Color Header = Color.FromArgb(49, 46, 129);
    public static readonly Color Sidebar = Color.FromArgb(15, 23, 42);
    public static readonly Color Card = Color.FromArgb(31, 41, 55);
    public static readonly Color CardElevated = Color.FromArgb(38, 50, 68);
    public static readonly Color Text = Color.FromArgb(248, 250, 252);
    public static readonly Color TextMuted = Color.FromArgb(203, 213, 225);
    ...
    public static void StyleButton(Button button)
    {
        ...
        button.FlatAppearance.MouseOverBackColor = Lighten(button.BackColor, 24);
    ...
    public static void StyleGrid(DataGridView grid)
    {
        ...
        grid.RowsDefaultCellStyle.SelectionBackColor = Teal;
        ...
        grid.AlternatingRowsDefaultCellStyle.SelectionBackColor = Teal;
    ...
    public static Color GetDashboardCardColor(string name)
    {
        return name switch
        {
            ...
            "cardProdutos" => WarningDark,
            "cardClientes" => Color.FromArgb(67, 56, 202),
            _ => Card
        };
    }
